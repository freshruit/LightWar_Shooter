...
def main():
    ...
    # Построение алгоритмов взаимодействия в зависимости от числа спрайтов
    ...
    while True:
        # Осуществление передвижения персонажа, обновление его местоположения в зависимости от скорости
        player.movement()
